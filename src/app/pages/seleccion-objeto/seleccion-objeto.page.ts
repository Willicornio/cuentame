...
@Component({
  selector: 'app-seleccion-objeto',
  templateUrl: './seleccion-objeto.page.html',
  styleUrls: ['./seleccion-objeto.page.scss'],
})
export class SeleccionObjetoPage implements OnInit {
 ...
 listaFotosObjetos: ImagenRecurso [] = [];
 listaFotosObjetosEspeciales: ImagenRecurso [] = [];
   ...
   else   if(this.alumnoJuegoCuento.nivel2 == false)
   {
    ...
    this.fotosBackend.forEach(elemento => {
             ...
             if(elemento.especial == true && this.muestraEspeciales == true)
             {
                ...
                foto.tipo = elemento.tipo;
                foto.url = elemento.url;
                this.listaFotosObjetosEspeciales.push(foto);
